kecepatan = 27;kecepatan2=30;
ftganti=0;fungsi=0;ftfungsi=0;fungsiAwal=0;fungsitimer=0;deffotostiker=fotostiker.src;Content.style = "opacity:1;margin-top:0vh;";wallpaper.style="opacity:1";
  ...
  async function mulainama() {
           ...
           Content.style = "opacity:1;margin-top:3vh";
           bodyblur.style="";
  ...
  function bqmuncul(){bq.style = "position:relative;opacity:1;visibility:visible;transform: scale(1);margin-top:10px";setTimeout(mulaiketik1,200);fungsi=1;}
  ...
  async function menuju(){window.location = "https://t.me/rendrapiscela?text=Hi..";}
  ...
  afterComplete: function(){
    ...
    if (opsLcheck !== jumlahP) {setInterval(updateProgressBar, 200);opsLclick=1;/*otopsL();*/} else {ftganti += 1;fthilang();setTimeout(ftmuncul, 400);setInterval(berjatuhan,200);}
  },}).go();
  }
